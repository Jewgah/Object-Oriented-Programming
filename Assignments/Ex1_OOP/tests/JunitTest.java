...
class JunitTest {
    ...
    @Test
    void Million_nodes_and_edges() {

        weighted_graph g1 = graph_creator(1000000, 1000000, 1);
        assertEquals(1000000, g1.edgeSize());
    ...
    void edgeSize() {
        ...
        double edge03 = g.getEdge(0,3);
        double edge30 = g.getEdge(3,0);
        assertEquals(edge03, edge30);
        assertEquals(edge03, 3);
    }
